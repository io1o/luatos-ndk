...
unsigned long CFW_TcpipGetLastError(void);
...
**                 DEBUG                  **
*******************************************/
VOID OPENAT_print(const char * fmt, ...);

VOID OPENAT_lua_print(const char * fmt, ...);

void   OPENAT_assert( char condition,  char *func, unsigned int line);
INT64 OPENAT_get_system_tick(VOID);
