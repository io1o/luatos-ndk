...
#define IN_VER "LUA_SIMULATOR_IN_VER"
#define EX_VER "LUA_SIMULATOR_EX_VER"
...
#if defined(LUA_USE_MTK_NUCLEUS)
...
#elif defined(LUA_USE_COOLSAND_SXR) || defined(LUA_USE_MTK_NUCLEUS)
#define LUA_ROOT	"/"
...
*/
#define LUAI_GCPAUSE	110  /* 200% (wait memory to double before next GC) */
